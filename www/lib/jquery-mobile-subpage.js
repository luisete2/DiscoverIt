...
(function($, undefined) {
    ...
    $.widget("mobile.subpage", {
        ...
        _createSubPage: function() {
            ...
            newPage.attr("data-" + $.mobile.ns + "url", subpageUrl).attr("data-" + $.mobile.ns + "role", 'page');
            ...
            if (!self.parentPage.data("mobile-page").options.domCache && self.parentPage.is(":jqmData(external-page='true')")) {
                ...
                self.parentPage.off("pageremove").on("pageremove", parentPageRemove);
                self.parentPage.unbind("pagehide.remove").bind("pagehide.remove", parentPageHideRemove);
            }
        },
