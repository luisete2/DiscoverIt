...
Calendar.prototype.createEventWithOptions = function (title, location, notes, startDate, endDate, options, successCallback, errorCallback) {
  ...
  try {
    ...
    errorCallback("invalid startDate or endDate. " + JSON.stringify(e) );
  }
  if (!(startDate instanceof Date && endDate instanceof Date)) {
    errorCallback("invalid startDate or endDate. Both must be JavaScript Date Objects. " + startDate + " - " + endDate);
    return;
  }
